...
if($api->connect($host_mkt,'admin','PinoSuar')){       
    ...
    // [last-disconnect-reason] => peer-request [disabled] => false [comment] => Pruebas ) 1
        ...
        // if($array[$i]["disabled"]=="false"){
            $listado .= "<td><span class='badge badge-success'>activado</span><a href='desactivarPPP.php?id=".$array[$i][".id"] ."' class='btn btn-danger'><i class='fa fa-eye'>".$array[$i][".id"] ."</i></a></td>";
        // }
        // else{
